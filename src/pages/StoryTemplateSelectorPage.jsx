...
import { STORY_TEMPLATES, TEMPLATE_TYPES } from '../components/templates';
...
const StoryTemplateSelectorPage = () => {
  ...
  const templateImages = {
    1: 'https://images.unsplash.com/photo-1607623814075-e51df1bdc82f?auto=format&fit=crop&q=80&w=1200', // Beef
    2: 'https://images.unsplash.com/photo-1452860606245-08befc0ff44b?auto=format&fit=crop&q=80&w=1200', // Artisan
  };

  // Template descriptions
  const templateDescriptions = {
    1: 'Perfect for showcasing premium meat products, butchery craftsmanship, and farm-to-table stories',
    2: 'Ideal for artisan products, handcrafted goods, and makers who value authentic storytelling',
  };

  // Template preview data (sample data for preview)
  const getPreviewData = (templateId) => {
    return {
      body: JSON.stringify({
        heroTitle: 'Your Farm Story',
        heroSubtitle: 'Share your journey with customers',
        aboutTitle: 'Our Story',
        aboutText: 'This is where your story begins...',
      })
    };
  };
  ...
  const handleEditTemplate = async () => {
    ...
    try {
      ...
      const draftData = {
        ...
        name: `New ${selectedTemplate.displayName} Story`,
        body: JSON.stringify({
          heroTitle: 'Your Farm Story',
          heroSubtitle: 'Share your journey with customers',
          aboutTitle: 'Our Story',
        ...
        <div className="fixed top-0 left-0 right-0 bg-white shadow-md z-50 px-4 sm:px-6 py-3 sm:py-4 z-1">
          <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0">
            ...
            <button
              ...
              disabled={loading}
              className="flex items-center px-4 sm:px-6 py-2 bg-[#83aa45] text-white rounded-lg hover:bg-[#7A8449] transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base w-full sm:w-auto justify-center"
            >
